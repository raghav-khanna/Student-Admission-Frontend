...
const arr1data_eligibility_criteria=[["The applicant must be pursuing B.Tech./B.E. 1st Year (2nd semester) from a recognized University/ Institute.",
"The applicant must have appeared in Paper 1 (B.E. /B.Tech.) during one or more sessions of JEE (Main) 2021 Examination conducted by the National Testing Agency (NTA), and the applicant must have a JEE (Main) 2021 examination NTA (percentile) score equal or above the LNMIIT Cut-off scores of the admission year 2021-22 in the programme in which admission is sought.","The applicant must have passed Class 12th (10+2) examination with Mathematics and Physics as compulsory subjects along with one out of Chemistry/ Computer Science/Electronics/Information Technology/ Biology/Informatics Practices/ Biotechnology/ Technical Vocational subject.",
...
const arr2head_seat_allotment=["Seat Allotment Process and Result Declaration","Note:"];
const arr2data_seat_allotment=[["Allotment of seats will be in online mode only.",
