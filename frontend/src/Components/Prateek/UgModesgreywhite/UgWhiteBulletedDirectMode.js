...
const arr1data_specialization_minor = [
  "The admitted students may have the opportunity to opt for applicable specialization and/or minor programs as per merit and depending on availability.",
];

const arr2head_selection_procedure = ["Selection Procedure"];
const arr2data_selection_procedure = [
...
const arr3data_note_below_fee_structure = [
