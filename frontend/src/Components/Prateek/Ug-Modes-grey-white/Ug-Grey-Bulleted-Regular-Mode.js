const arr1_head_note_eligi = ["Note:","Eligibility Criteria"];
const arr1_data_note_eligi = [["The Institute has no provision for either Capitation Fee or Management Quota",
                        ...
                        ["The applicant must be a citizen of India. (Candidates holding OCI status must have to apply under DASA mode.","The applicant must be appearing in Paper 1 (B.E. /B.Tech.) during one or more sessions of JEE (Main) 2022 Examination conducted by the National Testing Agency (NTA).",
...
const arr2head_merit_list = ["Merit List Preparation"];
const arr2data_merit_list = [["A Merit List will be prepared solely based on the Final NTA score (percentile) obtained in Paper-1 (B.E./B.Tech.)   in JEE (Main) 2022 Examination for all eligible applicants.",
...
const arr3head_seat_allotment = ["Seat Allotment Process"];
const arr3data_seat_allotment = [["Applicants who pay the Provisional Fee of INR 25,000/- (Rupees Twenty Five Thousand Only) within the specified date will only be considered in the seat allotment process.",
