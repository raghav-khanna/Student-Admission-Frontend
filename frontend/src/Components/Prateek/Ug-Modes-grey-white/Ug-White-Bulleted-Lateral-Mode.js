const arr1head_note_under_specialization_minor = ["Note:"];
const arr1data = [
...
const arr2head_instruction_lateral_entry = [
  "Instructions for Lateral Entry Mode",
];
const arr2data_instruction_lateral_entry = [
...
const arr3head_note__below_fee_structure = ["Note:"];
