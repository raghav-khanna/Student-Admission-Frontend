...
const MTech = () => {
    return (
        <div>
            ...
            <Temp x={"Eligibility Criteria"} arr={elecrit} dataArray={null} color={"#f2f2f2"} />
            <Temp x={null} arr={null} dataArray={ins2apply} color={"white"} />
            <FeeStructure fee_title={"Fee Structure for M.Tech. & M.S. (by Research) in INR"} fee_arr={["10,000", "3,000", "96,660"]} mess_arr={["25,000", "6,600", "500", "1,500", "17,000"]} bulletarr={fee_note} colr={"#f2f2f2"} />
